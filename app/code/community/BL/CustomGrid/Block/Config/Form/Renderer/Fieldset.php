...
class BL_CustomGrid_Block_Config_Form_Renderer_Fieldset extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('bl/customgrid/config/form/renderer/fieldset.phtml');
    }
    ...
    public function getElementCollapseState(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        return (!is_null($state) ? (bool) $state : true);
    }
}
