...
class BL_CustomGrid_Model_Custom_Column_Invoice_Items_Custom extends BL_CustomGrid_Model_Custom_Column_Invoice_Items_Abstract
{
    ...
    {
        return 'blcg_custom_column_invoice_items_custom_values';
    }
