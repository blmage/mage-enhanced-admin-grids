    ...
    extends BL_CustomGrid_Model_Custom_Column_Simple_Abstract
{
    ...
    public function getCustomFilterOperators($asOptionsArray=false)
    {
        ...
        return ($asOptionsArray ? $helper->getOptionsArrayFromOptionsHash($operators) : $operators);
    }
    ...
    protected function _prepareConfig()
    {
        ...
        $descriptions = array(
            ...
            'ascent_limit' => 'If needed, indicate here the level on which to stop ascent for the full paths display.'
                . ' At least one level will be displayed in all cases, even if the concerned category has a lower level',
            'custom_filter_operator' => 'Filtered products will have to belong to a number of categories amongst the'
                . ' chosen ones, that can be verified using this value and the one from the "Custom Filter - Number"'
                . ' field',
            'custom_filter_number' => 'Filtered products will have to belong to a number of categories amongst the'
                . ' chosen ones, that can be verified using this value and the one from the "Custom Filter - Operator"'
                . ' field',
        );
    ...
    protected function _getCategoryIdsSelect(Varien_Data_Collection_Db $collection, $forFilter=false, $categoryIds=null)
    {
