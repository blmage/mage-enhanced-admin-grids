...
`origin` enum('grid', 'collection', 'attribute') NOT NULL default 'grid',
...
CREATE TABLE IF NOT EXISTS `{$installer->getTable('customgrid_options_source')}` (
...
CREATE TABLE IF NOT EXISTS `{$installer->getTable('customgrid_options_source_model')}` (
...
CREATE TABLE IF NOT EXISTS `{$installer->getTable('customgrid_options_source_option')}` (
